...
parser.add_argument('--basepath', type=str, default='/var/lib/docker/models/Meta-Llama-3.1-70B-Instruct-AWQ-INT4')
parser.add_argument('--tmpdir', type=str,
                    default='/var/lib/docker/datasets/eagle/llama3.1-70b-instruct-awq-novita0812-13k')
parser.add_argument('--outdir', type=str, default='0')
parser.add_argument('--cpdir', type=str, default='/var/lib/docker/train/20240930-eagle-llama3.1-70b')
